            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-100 dark:bg-gray-800">
                    <tr class="border-b">
                        ...
                        <th class="p-4 text-left font-medium text-gray-700 dark:text-gray-300" wire:click="sortBy('name')" role="button">
                        ...
                        <th class="p-4 text-left font-medium text-gray-700 dark:text-gray-300">Contact</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700">
                    @forelse($members as $member)
                        <tr class="border-b transition-colors hover:bg-gray-100 dark:hover:bg-gray-800">
                            <td class="w-4 p-4">
                            ...
                            <td class="p-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ $member->home_town }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="p-4">
